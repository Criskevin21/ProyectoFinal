...
import com.cristhoper.ec3.databinding.ItemShowResumeBinding;
import com.cristhoper.ec3.model.Platillo1;
...
public class RVResumeAdapter extends RecyclerView.Adapter<RVResumeAdapter.ResumeVH> {
    ...
    class ResumeVH extends RecyclerView.ViewHolder{
        ...
        public void bind(Shows show) {
            if (show instanceof Platillo1){
                binding.txtPlatillo.setVisibility(View.GONE);
            } else if (show instanceof Platillo2){
                binding.txtPlatillo.setVisibility(View.VISIBLE);
                binding.txtPlatillo.setText("platillo " +( (Platillo2) show).getPlatillo2());
            }
            binding.txtDescrip.setText(show.getName());
